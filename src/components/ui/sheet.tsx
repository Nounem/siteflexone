...
interface SheetOverlayProps extends
  ...
  <SheetPortal>
    ...
    <SheetPrimitive.Content
      ...
      className={cn(
        ...
        {
          "inset-y-0 right-0 h-full w-3/4 sm:w-2/5 data-[state=closed]:slide-out-to-right data-[state=open]:slide-in-from-right":
            side === "right",
          "inset-y-0 left-0 h-full w-3/4 sm:w-2/5 data-[state=closed]:slide-out-to-left data-[state=open]:slide-in-from-left":
            side === "left",
          "inset-x-0 top-0 h-3/4 sm:h-2/5 data-[state=closed]:slide-out-to-top data-[state=open]:slide-in-from-top":
            side === "top",
          "inset-x-0 bottom-0 h-3/4 sm:h-2/5 data-[state=closed]:slide-out-to-bottom data-[state=open]:slide-in-from-bottom":
            side === "bottom",
        },
        className
      )}
