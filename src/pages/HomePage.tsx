  ...
  return (
    ...
    <div className="flex flex-col min-h-screen">
          ...
          <div className="max-w-3xl mx-auto text-center">
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center animate-fade-in-up">
              <Link to="/trouver-une-salle">
                <Button size="lg" className="w-full sm:w-auto bg-cyan text-navy hover:bg-white">
                  Trouver une salle
      ...
      <section className="py-16 md:py-24 bg-white">
        <div className="container mx-auto px-4">
          <div className="text-center mb-16">
            <h2 className="text-3xl md:text-4xl font-bebas text-navy mb-4">Comment ça marche</h2>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            <div className="bg-white p-6 rounded-xl shadow-card hover:shadow-card-hover transition-shadow duration-300 animate-fade-in">
              <div className="bg-blue-50 h-16 w-16 flex items-center justify-center rounded-full text-navy mb-6">
      ...
      <section className="py-16 md:py-24 bg-gray-50">
        <div className="container mx-auto px-4">
          <div className="flex justify-between items-center mb-12">
            <h2 className="text-3xl md:text-4xl font-bebas text-navy">Salles en vedette</h2>
            <Link to="/trouver-une-salle" className="text-navy font-medium flex items-center hover:underline">
              Voir toutes les salles <ArrowRight className="ml-2 h-4 w-4" />
            </Link>
          </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
              {featuredGyms.map((gym, index) => (
                <Link 
                  key={gym.id}
                  to={`/salle/${gym.id}`}
                  className="bg-white rounded-xl shadow-card hover:shadow-card-hover transition-shadow duration-300 overflow-hidden group animate-fade-in"
      ...
      <section className="py-16 md:py-24 bg-white">
        <div className="container mx-auto px-4">
          <div className="text-center mb-16">
            <h2 className="text-3xl md:text-4xl font-bebas text-navy mb-4">Pour qui ?</h2>
            <p className="text-gray-600 max-w-2xl mx-auto">
      ...
      <section className="py-16 md:py-24 bg-gray-50">
        <div className="container mx-auto px-4">
          <div className="text-center mb-16">
            <h2 className="text-3xl md:text-4xl font-bebas text-navy mb-4">Ce qu'ils disent de nous</h2>
            <p className="text-gray-600 max-w-2xl mx-auto">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            <div className="bg-white p-6 rounded-xl shadow-card">
              <div className="flex items-center mb-4">
                <div className="h-12 w-12 rounded-full bg-blue-100 flex items-center justify-center text-navy">
      ...
      {/* CTA */}
      <section className="py-16 md:py-24 bg-gradient-to-r from-navy to-blue-800 text-white">
        <div className="container mx-auto px-4 text-center">
          <h2 className="text-3xl md:text-4xl font-bebas mb-6">Prêt à trouver votre salle de sport idéale ?</h2>
